...
// Row 1 — logos 1 to 6
const row1Logos = [
  { id: 1, src: atlassian, alt: "Client 01", className: "h-8 min-[400px]:h-10 md:h-16" },
  { id: 2, src: cursor, alt: "Client 02", className: "h-8 min-[400px]:h-10 md:h-16" },
  { id: 3, src: paypal, alt: "Client 03", className: "h-8 min-[400px]:h-10 md:h-16" },
  { id: 4, src: honda, alt: "Client 04", className: "h-8 min-[400px]:h-10 md:h-16" },
  { id: 5, src: googlePhotos, alt: "Client 05", className: "h-8 min-[400px]:h-10 md:h-16" },
  { id: 6, src: leetcode, alt: "Client 06", className: "h-8 min-[400px]:h-10 md:h-16" },
];

// Row 2 — logos 7 to 12
const row2Logos = [
  { id: 7, src: linkedin, alt: "Client 07", className: "h-8 min-[400px]:h-10 md:h-16" },
  { id: 8, src: arcfox, alt: "Client 08", className: "h-8 min-[400px]:h-10 md:h-16" },
  { id: 9, src: replit, alt: "Client 09", className: "h-8 min-[400px]:h-10 md:h-16" },
  { id: 10, src: youtube, alt: "Client 10", className: "h-8 min-[400px]:h-10 md:h-16" },
  { id: 11, src: nike, alt: "Client 11", className: "h-7 min-[400px]:h-9 md:h-15" },
